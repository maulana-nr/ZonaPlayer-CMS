                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body mb-3">
                                                                Apakah artikel dengan judul : <b><?php echo $data_judul; ?></b> ingin dihapus?
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="mb-3 mt-3">
                                                                    ...
                                                                    <select class="form-select" id="kategori" name="kategori">
                                                                        ...
                                                                        ?>
                                                                        <option value="<?php echo $data_idkategori; ?>"
                                                                            selected><?php echo $data_kategori; ?></option>
                                                                    </select>
                                                                </div>
                                                                <div class="mb-3 mt-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            <label for="isi">Isi Artikel :</label>
                            <textarea class="form-control" rows="5" id="isi" name="isi"><?php ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="gambar" class="form-label">Gambar :</label>
                            <input class="form-control" type="file" id="gambar" name="gambar">
