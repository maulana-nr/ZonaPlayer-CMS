            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Silahkan kelolah kategori :</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-warning btn-sm" name="btn_ubah_kategori" data-bs-toggle="modal" data-bs-target="#modalFormUpdateKategori<?php echo $data_id_kategori; ?>">Ubah</button>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" rows="5" id="keteragan" name="keterangan"><?php echo $data_keterangan; ?></textarea>
                                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body mb-3">
                                                                Apakah Kategri dengan nama : <b><?php echo $data_nama; ?></b> ingin dihapus?
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            <label for="keterangan">Keterangan :</label>
                            <textarea class="form-control" rows="5" id="keteragan" placeholder="Masukan Keterangan..." name="keterangan"></textarea>
                        </div>
                        <div class="d-flex justify-content-end gap-2">
