...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Silahkan kelolah Penulis :</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="bi bi-people-fill"></i>
                            <button class="btn btn-primary" name="btn_penulis_baru" id="btn_penulis_baru" data-bs-toggle="modal" data-bs-target="#modalFormPenulis">Penulis Baru</button>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-warning btn-sm" name="btn_ubah_penulis" data-bs-toggle="modal" data-bs-target="#modalFormUpdatePenulis<?php echo $data_id_penulis; ?>">Ubah</button>
                                            ...
                                            <div class="modal fade" data-bs-backdrop="static" id="modalFormUpdatePenulis<?php echo $data_id_penulis; ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST">
                                                                ...
                                                                <div class="mb-3 mt-3">
                                                                    ...
                                                                    <input type="password" class="form-control" id="password" placeholder="Isi dengan password lama/baru" name="password">
                                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body mb-3">
                                                                Apakah Penulis dengan nama : <b><?php echo $data_nama; ?></b> ingin dihapus?
    ...
    <!-- Modal Form Penulis Baru -->
    <div class="modal fade" data-bs-backdrop="static" id="modalFormPenulis">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Penulis :</label>
                            <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Penulis..." name="nama">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="email" class="form-label">Email :</label>
