        ...
        <div class="container">
            <div class="text-center my-5">
                ...
                if (isset($_GET['id_kategori'])) {
                    ...
                    $query_kategori = "SELECT nama_kategori FROM kategori WHERE id_kategori = '$id_kategori'";
                    $hasil_kategori = mysqli_query($conn, $query_kategori);
                    if ($row_kategori = mysqli_fetch_assoc($hasil_kategori)) {
                        echo '<h2 class="fw-bolder">Anda berada di kategori: ' . htmlspecialchars($row_kategori['nama_kategori']) . '</h2>';
                    } else {
                        echo '<h2 class="fw-bolder">Kategori tidak ditemukan</h2>';
                    }
                } else {
                    echo '<h1 class="fw-bolder">Selamat Datang di Shinrai Game!</h1>';
                    echo '<p class="lead mb-0">Temukan Rekomendasi Game Terbaik Untukmu</p>';
                }
                ?>
            </div>
        </div>
